...
public class Exemplo19 extends javax.swing.JFrame {
    ...
    private void mostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mostrarActionPerformed
        JOptionPane.showMessageDialog(null, cpf.getText()+"\n"+cnpj.getText()+"\n"+ telefone.getText() +"\n"+cep.getText());
        String cnpjNum = cnpj.getText();
        cnpjNum = cnpjNum.replace(".", "");
        cnpjNum = cnpjNum.replace("/", "");
        cnpjNum = cnpjNum.replace("-", "");
        JOptionPane.showMessageDialog(null,"Somente os números do CNPJ: "+ cnpjNum);
